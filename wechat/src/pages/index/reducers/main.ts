...
const INITIAL_STATE: IMainReducer = {
  ...
  request: {q: '', pageNum: 0, pageSize: 10, storeId: 0},
};
  ...
  return produce<IMainReducer>(state, (draftState) => {
    switch (type) {
      ...
      case Command.queryResult:
        draftState.storeBaseInfo = payload.storeBaseInfo;
        draftState.rechargeCardList = payload.rechargeCardList;
        draftState.timingCardList = payload.timingCardList;
        return draftState;
